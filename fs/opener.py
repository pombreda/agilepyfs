...
class AgileOpener(Opener):
    ...
    def get_fs(cls, registry, fs_name, fs_name_params, fs_path, writeable, create_dir):
        ...
        agilefs = AgileFS('https://api.lama.lldns.net','username','password')
        agilefs.cache_hint(True)

        if fs_path:
            return agilefs, '/'+fs_path
        else:
            return agilefs, '/'
...
class LAMAOpener(Opener):
    ...
    def get_fs(cls, registry, fs_name, fs_name_params, fs_path, writeable, create_dir):
        ...
        lamafs = LAMAFS('https://api.lama.lldns.net','username','password')
